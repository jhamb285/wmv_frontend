    ...
    >
      ...
      <div className="stacked-card-header" style={{ alignItems: 'flex-start', gap: '12px' }}>
        ...
        <div style={{ flexShrink: 0, display: 'flex', alignItems: 'stretch' }}>
          <img
            src={(event as any).media_url_1 || (event as any).media_url_2 || 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVW-pbYSH_W9UliC5eEBX7oWNcsAJN9LETGg&s'}
            ...
            onError={(e) => {
              (e.currentTarget as HTMLImageElement).src = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVW-pbYSH_W9UliC5eEBX7oWNcsAJN9LETGg&s';
            }}
          />
        </div>
      </div>
