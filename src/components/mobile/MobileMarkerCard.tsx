...
const MobileMarkerCard: React.FC<MobileMarkerCardProps> = ({
  card,
  getCategoryColor,
  isFullScreen,
  onFullScreenToggle,
  ...
  // =============================================
  // COLLAPSED PREVIEW CARD (shown on marker click)
  // =============================================
  return (
    <div
    ...
    >
      ...
      {/* Date Pills Row + Expand/Close Buttons */}
...
export default MobileMarkerCard;
