...
> - **[Frontend Architecture](./docs/FRONTEND_ARCHITECTURE.md)** - Complete component structure, state management, and filtering system
> - **[Backend & API](./docs/BACKEND_API.md)** - API routes, database schema, and data processing
> - **[Technical Implementation](./TECHNICAL_IMPLEMENTATION.md)** - Architecture deep dive and implementation patterns
