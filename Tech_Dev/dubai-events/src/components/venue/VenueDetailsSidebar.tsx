...
import { X, MapPin, Clock, Instagram, ExternalLink, Users, Calendar, Music, TrendingUp, DollarSign, Gift, MessageCircle, BarChart3, Sparkles, Target } from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto px-4 pt-2 pb-6 max-h-[calc(100vh-8rem)] scrollbar-thin">
            ...
            <div className="py-3">
              ...
              {venue && (venue.address || venue.website) && (
