...
- Initial commit with all project files including dubai-events-v6 (latest version)

### Repository Structure
```
WMV/
├── Tech_Dev/
│   ├── dubai-events-v6/      # Latest working version (PRODUCTION)
│   ├── dubai-events-v5/      # Previous version
│   ├── dubai-events-v3/      # Older version
│   ├── dubai-events-v2/      # Older version
...
- https://dubai-events-v6-qvoz4clmz-jhamb285s-projects.vercel.app (latest deployment)
...
- **Vercel Dashboard**: https://vercel.com/jhamb285s-projects/dubai-events-v6
