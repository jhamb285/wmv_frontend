...
export async function GET() {
  try {
    ...
    console.log('✅ Found venue categories:', venueCategories);
    console.log('✅ Found special offers:', uniqueOffers);
    console.log('✅ Found event times (categorized):', orderedTimes);
    console.log('✅ Found ticket price ranges:', ticketPriceRanges);
    console.log('✅ Found venue prices from DB:', uniqueVenuePrices);
    console.log('✅ Found atmospheres:', uniqueAtmospheres);
    console.log('✅ Found event categories:', uniqueEventCategories);
