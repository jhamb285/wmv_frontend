...
> - **[Frontend Architecture Documentation](./docs/FRONTEND_ARCHITECTURE.md)** - Complete frontend architecture, components, hooks, and patterns
> - **[Backend & API Documentation](./docs/BACKEND_API.md)** - Complete backend architecture, API routes, and database schema
